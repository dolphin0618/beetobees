<template>
	<section class="re-box">
		<div class="step1">
			...
			<div class="f-box">
				<div class="f-item">
					<input type="number" class="ipt" placeholder="请输入手机号/邮箱"/>
				</div>
				<div class="f-item">
					<a href="javascript:;" class="btn disable">下一步</a>
				</div>
			</div>
		...
		<div class="step2">
			...
			<div class="f-box">
				<p class="desc">已向您的手机 185****2134发送一条验证码短信</p>
				<div class="f-item">
					<input type="number" class="ipt" placeholder="请输入手机验证码"/>
				</div>
				<div class="f-item">
					<input type="password" class="ipt" placeholder="请输入密码（6-20位英文或数字）"/>
				</div>
				<div class="f-item">
					<a href="javascript:;" class="btn">重新发送验证码</a>
					<a href="javascript:;" class="btn black disable">59s</a>
				</div>
				<div class="f-item">
